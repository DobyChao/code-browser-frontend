...
export default function HomePage({ repositories, onOpenRepo, isLoading, onOpenSettings }: HomePageProps) {
  ...
  return (
    <div className="p-8 h-full overflow-y-auto relative bg-bg-default">
      <button
        title="设置"
        className="absolute top-4 right-4 p-2 rounded-md text-text-dim hover:bg-bg-hover"
